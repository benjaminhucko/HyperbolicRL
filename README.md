...
- breakout
```bash
python main.py --geometry euclidean --epochs 10 --distributional --analyze --visualize --env breakout
python main.py --geometry hyperbolic --epochs 40 --distributional --analyze --visualize --env breakout
```
- freeway
```bash
